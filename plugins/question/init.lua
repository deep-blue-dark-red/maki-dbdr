...
local DESCRIPTION = [[Ask the user to choose or clarify mid-task. Recommended option first, suffixed "(Recommended)". A "type your own" choice is added automatically — don't add a catch-all option. Set multiSelect for multiple picks.]]
